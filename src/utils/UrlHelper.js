...
const rocketUrl = (tokenId) =>
  `${config.rocketUrlMiniThumbs}/${tokenId}${config.thumbFiletype}`;
const fuelUrl = (tokenId) =>
  `${config.fuelUrlMiniThumbs}/${tokenId}${config.thumbFiletype}`;
